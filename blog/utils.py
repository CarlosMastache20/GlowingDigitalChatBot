...
def check_all_messages(message):
        ...
        response( 'Para que te podamos contactar da click aqui para que rellenes nuestro formulario con tus datos y lo siguiente que haremos es comunicarnos contigo <a href="/blog/contacto" class="nav-link">Click aqui</a>' , ['datos', 'quiero', 'numero', 'contacto', 'contactar','contactenme', 'contacten', 'contactar' , 'contac' , 'mensaje', 'sms', 'llamar' , 'llamenme', 'llamen', 'empezar'], single_response=True)
