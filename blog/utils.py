...
def check_all_messages(message):
            ...
            response('Te comento,  nosotros somos una empresa dedicada a la medición de la interacción de distintos temas como son: autos, moda, viajes, maquillaje, etc. Trabajando de la mano del área publicitaria de Facebook logramos estas mediciones. En conclusión, nosotros usaremos tu perfil para crear una pagina en la cual se publicará contenido de los temas antes mencionados para ver la reacción de la gente. Nos encanta aclarar que tu perfil es totalmente respetado, así como jamás usamos tus datos personales para otros fines. <br> <button class="btn btn-primary" style="font-size: 11px;" onclick="getUserResponse5()" id="Send5" value="seguir leyendo"> Seguir leyendo  </button> <button class="btn btn-success" style="font-size: 11px;" onclick="getUserResponse4()" value="Ver video" id="Send4" > Un video <i class="fa-sharp fa-solid fa-circle-play"></i>   </button>' ,['tres'], single_response=True)

            

            response('¿Qué tal te pareció el video? ¿Deseas iniciar? <br> <a id="final1" class="btn btn-primary" style="font-size: 14px;" href="https://wa.me/qr/RFADP5HZ7RLND1"" target="_blank" onclick="getUserResponse6()">Si <button id="Send6" value="Si" hidden></button> <i class="fa fa-check"></i>  </a>  	<a id="final2" href="https://wa.me/qr/RFADP5HZ7RLND1"" target="_blank"  class="btn btn-warning" style="font-size: 14px;" onclick="getUserResponse7()" >Tengo dudas <button id="Send7" value="Tengo dudas" hidden></button>  </a>',['cuatro'], single_response=True)

            response('Los requisitos que pedimos para que tú puedas comenzar a obtener un ingreso extra con nosotros son muy pocos: <br> º Contar con un perfil de Facebook real (nombre real) y que sea activo. <br>º Tener al menos 6 meses de antigüedad con tu perfil. <br> º Que la cuenta por ingresar no esté o haya colaborado con otra empresa en un procedimiento similar. <br>Te recordamos que al colaborar con nosotros no tienes que invertir un solo peso. <br> <button class="btn btn-primary botonCelular"  onclick="getUserResponse8()" id="Send8" value="Seguir leyendo"> Seguir leyendo  </button>  <button class="btn btn-success"  style="font-size: 11px;"  onclick="getUserResponse4()" value="Ver video" id="Send4" > Un video <i class="fa-sharp fa-solid fa-circle-play"></i>   </button>' ,['cinco'], single_response=True)

            response('El colaborar con nosotros es súper fácil, ya que para generar tus primeros $2000 pesos solo tenemos que esperar a que Facebook nos apruebe tu página y tu perfil. Como nos regimos sobre las reglas y políticas de Facebook todo lo trabajamos a través del business manager, que es la parte publicitaria de Facebook, esto para que  puedas seguir teniendo un uso normal de tu cuenta. Es muy importante que en tu cuenta tengas tus datos actualizados (numero, correo y  nombre real).<br> <button class="btn btn-primary" style="font-size: 11px;" onclick="getUserResponse9()" id="Send9" value="Seguir leyendo"> Seguir leyendo  </button>  <button class="btn btn-success" style="font-size: 11px;" onclick="getUserResponse4()" value="Ver video" id="Send4" > Un video <i class="fa-sharp fa-solid fa-circle-play"></i>   </button>',['ocho'], single_response=True)

            response('Le daremos seguimiento a todo tu proceso a través de un grupo de WhatsApp, en el cual nos vas a compartir  el método de pago por el que te depositaremos. Tu única tarea será compartir la página que crearemos entre amigos y familiares para que así la verificación sea más rápida.<br> <p style="font-weight: bold;"> ¿Qué tal te pareció la información? ¿Deseas iniciar? </p> <a id="final1"  class="btn btn-primary" style="font-size: 14px;" href="https://wa.me/qr/RFADP5HZ7RLND1"" target="_blank" onclick="getUserResponse6()">Si <button id="Send6" value="Si" hidden></button> <i class="fa fa-check"></i>  </a>  	<a id="final2" href="https://wa.me/qr/RFADP5HZ7RLND1"" target="_blank"  class="btn btn-warning" style="font-size: 14px;" onclick="getUserResponse7()" >Tengo dudas <button id="Send7" value="Tengo dudas" hidden></button>  </a>',['nueve'], single_response=True)
